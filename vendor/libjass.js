(function(libjass, global) {
    ...
    (function(libjass) {
        ...
        if (libjass.Set === undefined || typeof libjass.Set.prototype.forEach !== "function") {
        ...
        if (libjass.Map === undefined || typeof libjass.Map.prototype.forEach !== "function") {
    ...
    (function(libjass) {
        (function(parser) {
             ...
             */
            function parse(input, rule, customParseTree) {
                if (typeof customParseTree === "undefined") {
                    customParseTree = null;
                }
            ...
            var ParserRun = function() {
                function ParserRun(input, rule, customParseTree) {
                    this._input = input;
                        ...
                        if (propertyNode !== null) {
                            if (sectionTemplateArray === null) {
                                ...
                                if (sectionTemplateArray === null && property.key === "Format") {
                                    ...
                                    sectionTemplateArray = [];
                                    sectionTemplateArray.formatSpecifier = property.value.split(",").map(function(formatPart) {
                                    ...
                                    if (sectionTemplate === null) {
                                        sectionTemplate = new libjass.Map();
                                ...
                                sectionTemplateArray.push(propertyNode.value);
                            }
                        } else {
                ...
                ParserRun.prototype.parse_assScriptProperty = function(parent) {
                    ...
                    if (parent.value !== null) {
                        ...
                        if (scriptSectionContents !== undefined && scriptSectionContents !== null) {
                            var formatSpecifier = scriptSectionContents.formatSpecifier;
    ...
    (function(libjass) {
        (function(renderers) {
            ...
            var RendererSettings = function() {
                 ...
                 * @static
                 */
                RendererSettings._from = function(fontMap, preRenderTime, preciseOutlines) {
                    ...
                    if (typeof preciseOutlines === "undefined") {
            ...
            var WebRenderer = function(_super) {
                ...
                WebRenderer.prototype.preRender = function(dialogue) {
                    ...
                    dialogue.parts.forEach(function(part) {
                        if (part instanceof libjass.parts.Italic) {
                            ...
                            var movePart = part;
                            sub.style.position = "absolute";
                            animationCollection.add("linear", [ new Keyframe(0, new libjass.Map().set("left", (_this._scaleX * movePart.x1).toFixed(3) + "px").set("top", (_this._scaleY * movePart.y1).toFixed(3) + "px")), new Keyframe(movePart.t1, new libjass.Map().set("left", (_this._scaleX * movePart.x1).toFixed(3) + "px").set("top", (_this._scaleY * movePart.y1).toFixed(3) + "px")), new Keyframe(movePart.t2, new libjass.Map().set("left", (_this._scaleX * movePart.x2).toFixed(3) + "px").set("top", (_this._scaleY * movePart.y2).toFixed(3) + "px")), new Keyframe(dialogue.end - dialogue.start, new libjass.Map().set("left", (_this._scaleX * movePart.x2).toFixed(3) + "px").set("top", (_this._scaleY * movePart.y2).toFixed(3) + "px")) ]);
                        } else if (part instanceof libjass.parts.Fade) {
                            var fadePart = part;
                            animationCollection.add("linear", [ new Keyframe(0, new libjass.Map().set("opacity", "0")), new Keyframe(fadePart.start, new libjass.Map().set("opacity", "1")), new Keyframe(dialogue.end - dialogue.start - fadePart.end, new libjass.Map().set("opacity", "1")), new Keyframe(dialogue.end - dialogue.start, new libjass.Map().set("opacity", "0")) ]);
                        } else if (part instanceof libjass.parts.ComplexFade) {
                            var complexFadePart = part;
                            animationCollection.add("linear", [ new Keyframe(0, new libjass.Map().set("opacity", complexFadePart.a1.toFixed(3))), new Keyframe(complexFadePart.t1, new libjass.Map().set("opacity", complexFadePart.a1.toFixed(3))), new Keyframe(complexFadePart.t2, new libjass.Map().set("opacity", complexFadePart.a2.toFixed(3))), new Keyframe(complexFadePart.t3, new libjass.Map().set("opacity", complexFadePart.a2.toFixed(3))), new Keyframe(complexFadePart.t4, new libjass.Map().set("opacity", complexFadePart.a3.toFixed(3))), new Keyframe(dialogue.end - dialogue.start, new libjass.Map().set("opacity", complexFadePart.a3.toFixed(3))) ]);
                ...
                WebRenderer.prototype.draw = function(dialogue) {
                    ...
                    var animationDelay = preRenderedSub.animationDelays.map(function(delay) {
                        return (delay + dialogue.start - _this.clock.currentTime).toFixed(3) + "s";
                    }).join(", ");
    ...
    (function(libjass) {
        ...
        var ASS = function() {
            ...
            ASS.prototype.addEvent = function(line) {
                var typedTemplateArray = [];
                typedTemplateArray.formatSpecifier = this._dialoguesFormatSpecifier;
                var typedTemplate = libjass.parser.parse(line, "assScriptProperty", new libjass.parser.ParseNode(null, {
                    contents: typedTemplateArray
                }));
             ...
             * @private
             */
            ASS.prototype._addEvent = function(line) {
            ...
            ASS._fromASSString = function(rawASS) {
                ...
                var infoTemplate = script.get("Script Info");
                if (libjass.verboseMode) {
                ...
                script.get("V4+ Styles").forEach(function(line) {
                    if (line.type === "Style") {
            ...
            ASS._fromSRTString = function(rawSRT) {
                ...
                var newStyle = new Style(new libjass.Map().set("Name", "Default").set("Italic", "0").set("Bold", "0").set("Underline", "0").set("StrikeOut", "0").set("Fontname", "").set("Fontsize", "50").set("ScaleX", "100").set("ScaleY", "100").set("Spacing", "0").set("Angle", "0").set("PrimaryColour", "&H0000FFFF").set("SecondaryColour", "&H00000000").set("OutlineColour", "&H00000000").set("BackColour", "&H00000000").set("Outline", "1").set("BorderStyle", "1").set("Shadow", "1").set("Alignment", "2").set("MarginL", "80").set("MarginR", "80").set("MarginV", "35"));
                result.styles.set(newStyle.name, newStyle);
                script.sort(function(line1, line2) {
                    return line1["number"] - line2["number"];
                }).forEach(function(line) {
                    result.dialogues.push(new Dialogue(new libjass.Map().set("Style", "Default").set("Start", line.start).set("End", line.end).set("Layer", "0").set("Text", line.text.replace(/<b>/g, "{\\b1}").replace(/<\/b>/g, "{\\b0}").replace(/<i>/g, "{\\i1}").replace(/<\/i>/g, "{\\i0}").replace(/<u>/g, "{\\u1}").replace(/<\/u>/g, "{\\u0}").replace(/<font color="#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})">/g, function(/* ujs:unreferenced */ substring, red, green, blue) {
                        return "{c&H" + blue + green + red + "&}";
                    }).replace(/<\/font>/g, "{\\c}")), result));
                });
                return result;
            };
            return ASS;
        ...
        var Style = function() {
            function Style(template) {
                ...
                this._primaryColor = libjass.parser.parse(template.get("PrimaryColour"), "colorWithAlpha");
                this._secondaryColor = libjass.parser.parse(template.get("SecondaryColour"), "colorWithAlpha");
                this._outlineColor = libjass.parser.parse(template.get("OutlineColour"), "colorWithAlpha");
                this._shadowColor = libjass.parser.parse(template.get("BackColour"), "colorWithAlpha");
